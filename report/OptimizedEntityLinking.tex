...
Currently our search formulation is highly parameter-dependent. The accuracy of our entity-linking directly relies on the choice of $\gamma$ and $\psi$

Relies on choosing a threshold for how similar words are. It is parameter dependent on $\gamma$ and $\psi$.
